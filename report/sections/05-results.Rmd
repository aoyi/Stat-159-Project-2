...
RSS.ols = residual_sum_squares_ols(ols.mod, full.set[,13])
RSS.ridge = residual_sum_squares_ridge_lasso(ridge.mod, best.lambda.ridge, full.set[,2:12], full.set[,13])
RSS.lasso = residual_sum_squares_ridge_lasso(lasso.mod, best.lambda.lasso, full.set[,2:12], full.set[,13])
RSS.pcr = residual_sum_squares_pcr_plsr(pcr.mod, best.m.pcr, full.set[,2:12], full.set[,13])
RSS.plsr = residual_sum_squares_pcr_plsr(plsr.mod, best.m.plsr, full.set[,2:12], full.set[,13])
